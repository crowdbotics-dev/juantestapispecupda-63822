...
## Project Structure
    ...
    ├── juantestapispecupda_63822  # Django project configurations
...
1. Clone this repo and `cd juantestapispecupda_63822`
...
2. Clone this repo and `cd juantestapispecupda_63822`
